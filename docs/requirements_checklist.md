...
| 15 | Decision log, 10-15 non-obvious decisions | [docs/decision_log.md](decision_log.md) — 14 entries (consolidated from an earlier 18 by merging closely-related decisions, not by deleting content) | Reviewed for filler; none found | PASS |
